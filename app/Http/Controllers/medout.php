...
class medout extends BadasoBaseController
{
    //
    ...
    public function add(Request $request)
    {
        DB::beginTransaction();
         for ($i=0; $i < count($data['obat']); $i++) {
                $this->insert([
                    'obat_id' => $data['obat'][$i],
                    'racikan_id' => $id_racikan,
                    'jumlah'=> $data['jumlah'][$i],
                    'created_at' => \Carbon\Carbon::now(),
                    'updated_at' => \Carbon\Carbon::now()
                ]);
                DB::table('obat')->where('id', $request['data'][$i])->decrement('stok', $request['jumlah'][$i]);
            }
        ...
        try {
            ...
            //         'obat_id' => $data['obat'][$i],
            //         'racikan_id' => $id_racikan,
            //         'jumlah_obat_dipakai' => $data['jumlah_obat_dipakai'][$i],
            //         'jumlah_obat_dibuat' => $data['jumlah_obat_dibuat'][$i],
            //         'created_at' => \Carbon\Carbon::now(),
            //         'updated_at' => \Carbon\Carbon::now()
            //     ]);
            //     DB::table('obat')->where('id', $request['data'][$i])->decrement('stok', $request['jumlah'][$i]);
